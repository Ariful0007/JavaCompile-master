...
public abstract class BaseFragment<P extends BasePresenter> extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (fragmentActivity instanceof BaseFragmentActivity) {
            ...
            throw new RuntimeException("Binding Fragment of the Activity Not inherited in BaseFragmentActivity");
        }
    }
    ...
    protected <T extends View> T findView(@IdRes int ids) {
        if (rootView == null) {
            throw new NullPointerException("The layout view introduced by Fragment is empty.");
        } else {
