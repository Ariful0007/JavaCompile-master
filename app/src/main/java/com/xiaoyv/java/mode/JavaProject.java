    ...
    public void init() {
        ...
        FileIOUtils.writeFileFromString(getProjectIniPath(),
                "The name of the project：" + projectName
                        + "\nThe time of creation：" + TimeUtils.getNowString()
                        + "\nCreate a tool：" + AppUtils.getAppName()
                        + "\nThe system version：" + DeviceUtils.getSDKVersionName()
                        + "\nTechnical support：arifulpub143@gmail.com");
